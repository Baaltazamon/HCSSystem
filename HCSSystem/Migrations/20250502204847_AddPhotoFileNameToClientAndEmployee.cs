...
{
    /// <inheritdoc />
    public partial class AddPhotoFileNameToClientAndEmployee : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyArea = table.Column<decimal>(type: "TEXT", nullable: false),
                    IsResidential = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndRegistrationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_UnitOfMeasurements_UnitOfMeasurementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meters_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Meters_Services_ServiceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    OwnershipStartDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    OwnershipEndDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeterReadings_Meters_MeterId1",
                        column: x => x.MeterId1,
                        principalTable: "Meters",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MeterReadings_Users_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeterReadings_MeterId1",
                table: "MeterReadings",
                column: "MeterId1");

            migrationBuilder.CreateIndex(
                name: "IX_Meters_ServiceId",
                table: "Meters",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Meters_ServiceId1",
                table: "Meters",
                column: "ServiceId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_UnitOfMeasurementId",
                table: "Services",
